    ...
    void Update()
    {
        ...
        if (pid.GetAsInt() != m_previousId) {
            ...
            else
            {
                ...
                if (parentProcessId.GetAsInt()!=0 && parentProcessId.GetAsInt() != m_parentProcessId) { 
                    m_previousProcessId.Invoke(m_parentProcessId);
                    m_previousProcessIdActiveChildren.Invoke(m_childrenId);
